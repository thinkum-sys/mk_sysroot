...
#
# Remarks
# - This shell script uses some BASH extensions, e.g BASH_SOURCE[0] and
#   as such, may not function as desired under any other SH
#
...
## typically would be installed under the conventional PKGSRC infodir
